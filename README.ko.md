...
Hugging Face의 **인기 모델 / 트렌딩 데이터셋 / 트렌딩 스페이스**와
최신 블로그(Latest Blogs), 최신 논문(Latest Papers)을 매일 수집해
...
| `NEWSLETTER_TOP_N` | 섹션별 개수(모델/데이터셋/스페이스) | 선택 | `12` |
| `NEWSLETTER_BLOG_TOP_N` | 최신 블로그 항목 개수 | 선택 | `5` |
